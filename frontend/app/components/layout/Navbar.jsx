                ...
                <div className="right w-3/4 lg:w-1/3 flex items-center justify-end space-x-2 md:space-x-4 lg:space-x-6">
                    ...
                    <div className=' flex items-center space-x-2 xl:space-x-4'>
                        {user && user._id ?
                            <Link href='/profile'>
                                {user?.profileImageId ?
                                    <Image className='rounded-full w-8 h-8' src={`${process.env.NEXT_PUBLIC_API_IMAGE_URL}/uploads/profiles/${user.profileImageId}`} alt="profileImage" height={200} width={200} />
                                    :
