    ...
    return (
        ...
        >
            <div className='flex flex-col space-y-1 border border-gray-400 border-opacity-25 shadow-lg shadow-gray-400'>
                <img src={`${process.env.NEXT_PUBLIC_API_IMAGE_URL}/uploads/products/${product.imageId[0]}`} className="w-full h-[16.5rem] object-cover" alt={`Slide ${index + 1}`} loading='lazy' />
